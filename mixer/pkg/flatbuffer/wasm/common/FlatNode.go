...
func (rcv *FlatNode) InstanceIps(j int) []byte {
...
func (rcv *FlatNode) InstanceIpsLength() int {
	o := flatbuffers.UOffsetT(rcv._tab.Offset(24))
	if o != 0 {
		return rcv._tab.VectorLen(o)
	}
...
func FlatNodeAddInstanceIps(builder *flatbuffers.Builder, instanceIps flatbuffers.UOffsetT) {
	builder.PrependUOffsetTSlot(10, flatbuffers.UOffsetT(instanceIps), 0)
}
func FlatNodeStartInstanceIpsVector(builder *flatbuffers.Builder, numElems int) flatbuffers.UOffsetT {
	return builder.StartVector(4, numElems, 4)
}
